...
public class MyHeader extends RelativeLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        RelativeLayout.LayoutParams lpProgress = new RelativeLayout.LayoutParams(density.dip2px(20), density.dip2px(20));
    ...
    public MyHeader setLastUpdateTime(Date time) {
        mLastTime = time;
        mLastUpdateText.setText(mFormat.format(time));
        return this;
    }

    public MyHeader setTimeFormat(DateFormat format) {
        mFormat = format;
        mLastUpdateText.setText(mFormat.format(mLastTime));
        return this;
    }

    public MyHeader setSpinnerStyle(SpinnerStyle style) {
